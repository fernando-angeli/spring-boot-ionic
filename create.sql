...
create table produto_itens (produto_id int4 not null, itens_pedido_id int4 not null, itens_produto_id int4 not null, primary key (produto_id, itens_pedido_id, itens_produto_id));
...
alter table if exists produto_itens add constraint UK_iwtr5m05wuh50waarx5l6gxi7 unique (itens_pedido_id, itens_produto_id);
...
alter table if exists produto_itens add constraint FKp1tjmk287if0h2ftilo10sda foreign key (itens_pedido_id, itens_produto_id) references item_pedido;
alter table if exists produto_itens add constraint FK454v375gmkj7e1nv48jkxsj3n foreign key (produto_id) references produto;
